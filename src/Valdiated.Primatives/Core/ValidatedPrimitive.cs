...
public abstract record ValidatedPrimitive<T> where T : notnull
{
    ...
    protected ValidatedPrimitive(T value)
    {
        Value = value;
    }

    protected ValidatedPrimitive(
        T value,
    ...
    public static implicit operator T(ValidatedPrimitive<T> primitive)
    {
        return primitive.Value;
    }

    // Override equality to only compare Value, excluding Validators
    public virtual bool Equals(ValidatedPrimitive<T>? other)
    {
